...
### Desktop interfejs
- Novi izgled prilagoden desktopu — sidebar navigacija, status bar, tamna tema (Segoe UI)
- Sklopivi sidebar; footer i status bar iste visine
- Bootstrap 5 i ikone ugradeni u program — radi bez interneta
- Dugme **Prekini** u status baru tokom uploada

### Programi / Igrice / Muzika
- Poseban tab za upload sadrzaja koji nije na TMDB-u
- Kreiranje torrenta i direktan upload na sajt
- Izbor kategorije preko **ID-a** sa liste sa sajta
- Prikaz imena kategorije, poravnata polja, validacija forme

### Upload pipeline (film / serija)
- Titlovi u upload pregledu: samo **SR, HR, BA**
- Pipeline koraci sa **Poništi** — bez preklapanja sa progress barom
- IMDB, screenshots, torrent i upload u pozadini — UI ostaje odzivan

### Podešavanja
- Ukljuci ili iskljuci **automatski YouTube trailer** u generisanom opisu

### Stabilnost i odrzavanje
- Zajednicki `crnaberza_core` modul za torrent, TMDB i tekstualne pomocne funkcije
- Unit testovi za kljucnu logiku
- Ciscenje mrtvog koda i nepotrebnih fajlova iz projekta
...
- **Lokalizovani opis** — pokusava sr-RS → hr-HR → bs-BS, zatim Google Translate (EN→SR)
